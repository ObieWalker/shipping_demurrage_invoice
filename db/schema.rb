...
ActiveRecord::Schema[7.2].define(version: 2025_09_11_024736) do
  create_table "bl", primary_key: "id_bl", id: :integer, charset: "latin1", force: :cascade do |t|
    ...
    t.string "numero_bl", limit: 9, null: false, collation: "utf8mb4_unicode_ci"
    t.integer "id_client"
  ...
  create_table "facture", primary_key: "id_facture", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    ...
    t.date "due_date"
    t.index ["numero_bl"], name: "index_facture_on_numero_bl"
  ...
  add_foreign_key "facture", "bl", column: "numero_bl", primary_key: "numero_bl", name: "fk_facture_bl_numero"
end
